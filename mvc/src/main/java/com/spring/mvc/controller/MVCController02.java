...
//    localhost:8080/chap02/hobbies
    ...
    public String hobbies(Model model){ // .jsp로 자바 변수를 보내려면 Model을 선언부에 선언
        String name = "호야";
        List<String> hobbies = List.of("밥먹기", "낮잠자기", "냥기장"); // List 자료형 생성 및 자료 저장
...
//        .jsp파일(view단) 으로 보내고 싶은 자료 설정
        String name = "비둘기";
        List<String> hList = List.of("사람이 지나가도 안 날아가기", "걸어다니기", "음식물 쓰레기 뒤지기");
